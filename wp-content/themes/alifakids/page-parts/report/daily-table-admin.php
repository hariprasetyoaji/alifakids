                ...
                <tr>
                  ...
                  <td class="align-middle text-right">
                    ...
                    <?php elseif($item['status'] == 1): ?>
                      <a class='btn btn-warning btn-sm'  href="<?php echo add_query_arg($url_arg,site_url('report-harian/add')); ?>">Ubah</a>
                    <?php else: ?>
                      <a class='btn btn-primary btn-sm' href="<?php echo add_query_arg($url_arg,site_url('report-harian/add')); ?>">Tambah</a>
                    <?php endif ?>
                  </td>
                </tr>
                <?php 
