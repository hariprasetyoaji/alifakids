...
$items = $table->prepare_items(10, $paged);
                ...
                <tr>
                  ...
                  <td class="align-middle text-right">
                    <?php if ($item['status'] == 2): ?>
                      <a class='btn btn-sm' href='#' disabled>Telah diterima ortu</a>
                    <?php elseif($item['status'] == 1): ?>
                      <a class='btn btn-warning btn-sm'  href="<?php echo add_query_arg($url_arg,site_url('report-mingguan/add')); ?>">Ubah</a>
                    <?php else: ?>
                      <a class='btn btn-primary btn-sm' href="<?php echo add_query_arg($url_arg,site_url('report-mingguan/add')); ?>">Tambah</a>
                    <?php endif ?>
                  </td>
                </tr>
                <?php 
